...
export default function Home() {
  ...
  const [modalType, setModalType] = useState<'progress' | 'subject' | 'task' | 'create-subject' | 'create-task' | 'delete-subject' | 'delete-task' | null>(null)
  ...
  const openModal = (type: 'progress' | 'subject' | 'task' | 'create-subject' | 'create-task', id?: string, currentValue?: string | number) => {
    setModalType(type)
              ...
              >
                ...
                <div className="flex items-start justify-between relative z-10">
                  ...
                  <div className="flex items-center gap-1 ml-2">
                    <button
                      onClick={() => openModal('create-task', subject.id, '')}
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-6 animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-lg font-semibold text-slate-800">
                ...
                {modalType === 'create-task' && 'Add New Task'}
            ...
            {modalType === 'create-task' && editingItem && (
              <div className="space-y-6">
                <div>
                  <label className="block text-sm font-medium text-slate-600 mb-2">
                    Task Name
                  ...
                  <input
                    ...
                    onChange={(e) => setEditingItem({ ...editingItem, currentValue: e.target.value })}
                    onKeyDown={(e) => {
                      if (e.key === 'Enter' && String(editingItem.currentValue).trim()) {
                        handleCreateTask({ title: String(editingItem.currentValue).trim(), subjectId: editingItem.id })
                        closeModal()
                      }
                    }}
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    disabled={!String(editingItem.currentValue).trim()}
            ...
            {modalType === 'delete-subject' && editingItem && (
              <div className="space-y-6">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    onClick={() => {
                      handleDeleteSubject(editingItem.id)
                      closeModal()
                    }}
            ...
            {modalType === 'delete-task' && editingItem && (
              <div className="space-y-6">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    onClick={() => {
                      handleDeleteTask(editingItem.id)
                      closeModal()
                    }}
                    className="flex-1 px-4 py-2.5 rounded-xl bg-red-600 text-white font-medium hover:bg-red-700 transition-colors shadow-lg shadow-red-600/25"
                  >
