...
describe("Level 1 Task 1: Environment Setup", () => {
  ...
  // -------------------------------------------------------------------------
  it("should apply database migrations without errors", () => {
    /**
  ...
  // -------------------------------------------------------------------------
  it("should start the backend server and respond on the /health endpoint", async () => {
  ...
  it("should start the client dev server and serve the application", async () => {
    ...
    try {
      clientProcess = spawn(pnpmCmd, ["run", "dev"], {
        cwd: clientRoot,
        env: {
          ...safeEnv,
